...
cta:
  ...
  description: Get started with Customermates today, the open-source mortgage broker CRM with pipeline tracking, automation, and native AI integration at a flat €10/user/month.
  buttonLeftText: Start for free
  buttonLeftHref: /auth/signup
  buttonRightText: Watch live demo
  buttonRightHref: https://demo.customermates.com
