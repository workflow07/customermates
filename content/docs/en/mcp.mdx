...
description: Connect native AI integration, LLM tool clients, and MCP runtimes to Customermates CRM through the Model Context Protocol endpoint.
---
...
The following example shows the style of guidance you can feed to your MCP client to make CRM-aware reasoning consistent:
