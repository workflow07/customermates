...
description: Verbinde native KI-Integration, LLM-Tool-Clients und MCP-Runtimes über den MCP-Endpunkt mit dem Customermates CRM.
---
...
Praktisch bedeutet das: OpenAPI ist die Quelle für exakte Endpoint- und Schema-Details, während MCP die höhere Abstraktion für Workflows mit native KI-Integration ist.
...
Der folgende Block zeigt eine beispielhafte Anleitung, die du deinem MCP-Client mitgeben kannst, um CRM-basiertes Reasoning konsistent zu halten:
